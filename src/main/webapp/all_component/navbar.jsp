...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <i class="fa fa-plus-circle"></i>Post Job</a></li>
   ...
   <c:if test="${userobj.role eq 'admin' }">
    ...
    Admin
     ...
     <a href="login.jsp" class="btn btn-light"><i class="fas fa-sign-in-alt"></i>
     Logout</a>
       </c:if>
       
       
    <c:if test="${userobj.role eq 'user' }">
      <a href="#" class="btn btn-light mr-1" data-toggle="modal" data-target="modal" data-target="#exampleModal"><i class="fas fa-user"></i> 
      ${userobj.name}
      </a>
